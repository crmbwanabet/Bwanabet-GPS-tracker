...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Auto-resume tracking after an app update (service gets killed during install)
        if (!isTrackingEnabled() && userWantsTracking()) {
    ...
    private fun startTracking() {
        getSharedPreferences("tracker", MODE_PRIVATE)
            ...
            .putBoolean("user_wants_tracking", true)
            .apply()
    ...
    private fun stopTracking() {
        ...
        getSharedPreferences("tracker", MODE_PRIVATE)
            ...
            .putBoolean("user_wants_tracking", false)
            .apply()
        updateUI()
    }

    private fun userWantsTracking(): Boolean {
        return getSharedPreferences("tracker", MODE_PRIVATE)
            .getBoolean("user_wants_tracking", false)
    }
